...
import { FileText, AlertCircle, Check, Clock, Calendar, MapPin, MessageSquare, 
          Info, User, ChevronRight, X } from 'lucide-react';
...
const ServiceProviderJobPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      {/* Notification toast for messages */}
      {successMessage && (
        <div className="fixed bottom-6 right-6 bg-slate-900 text-white px-6 py-3 rounded-lg shadow-xl flex items-center animate-slide-up z-50">
      ...
      {error && (
        <div className="fixed bottom-6 right-6 bg-red-600 text-white px-6 py-3 rounded-lg shadow-xl flex items-center animate-slide-up z-50">
