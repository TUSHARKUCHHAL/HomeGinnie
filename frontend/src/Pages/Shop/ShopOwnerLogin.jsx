...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/shops/login`, {
        email,
        password
      });
        ...
        <div className="bg-white/95 backdrop-blur-sm mt-28 mb-12 rounded-xl shadow-md border border-slate-200 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="/ShopOwner-Forgot-Password" className="font-medium text-slate-600 hover:text-slate-800">
                    Forgot password?
                  </a>
                </div>
              </div>
            ...
            <p className="mt-6 text-center text-sm text-slate-600">
              ...
              <a href="/ShopOwner-SignUp" className="font-medium text-slate-800 hover:text-slate-700">
                Create an account
              </a>
            </p>
          </div>
