...
// import { Search, MapPin, ChevronDown, Home, Briefcase, MapPinned, Navigation, Loader } from 'lucide-react';
...
//     try {
//       const currentAddress = await LocationService.getCurrentLocation();
    ...
    <div className="flex flex-col md:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8 mt-16 w-160 ml-auto">
      ...
      <div className="md:w-3/5 relative" ref={addressInputRef}>
        ...
        <input
          type="text"
          className={`w-full pl-10 pr-10 py-3 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-slate-500 bg-white/80 backdrop-blur-sm shadow-sm transition-all duration-300 hover:bg-white/90 focus:bg-white ${addressBarFocused ? 'border-slate-500' : 'border'}`}
          value={activeAddress && addresses[activeAddress] ? addresses[activeAddress] : "Select Address"}
          readOnly
          onClick={() => setAddressBarFocused(true)}
          onFocus={() => setAddressBarFocused(true)}
        />
      ...
      {showAddressModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 modal-overlay">
          <div 
            ref={modalRef}
            className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md animate-popIn"
          >
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <button 
                className={`flex flex-col items-center justify-center py-3 rounded-lg border transition ${newAddressData.type === 'home' ? 'bg-slate-800 text-white border-slate-800' : 'bg-white border-slate-300 hover:bg-slate-100'}`}
              ...
              <button 
                className={`flex flex-col items-center justify-center py-3 rounded-lg border transition ${newAddressData.type === 'work' ? 'bg-slate-800 text-white border-slate-800' : 'bg-white border-slate-300 hover:bg-slate-100'}`}
              ...
              <button 
                className={`flex flex-col items-center justify-center py-3 rounded-lg border transition ${newAddressData.type === 'other' ? 'bg-slate-800 text-white border-slate-800' : 'bg-white border-slate-300 hover:bg-slate-100'}`}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-slate-500 focus:border-slate-500"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Pincode/Zip Code*</label>
              ...
              <div className="flex justify-end pt-2">
                <button 
                  className="bg-slate-800 hover:bg-slate-700 text-white font-medium rounded-lg px-5 py-2 transition shadow"
