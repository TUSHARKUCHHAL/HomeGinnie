...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const adminEmail = 'official.homeginnie@gmail.com';
    const adminPassword = 'HomeGinnie@123';
    ...
    try {
      ...
      if (email === adminEmail && password === adminPassword) {
        ...
        const userData = {
          ...
          email: adminEmail,
          role: 'admin',
          token: 'admin-token-' + Date.now() // Generate a simple token
        };
        
        // Update auth context with rememberMe parameter
        login(userData.token, 'admin', rememberMe);
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-white/95 backdrop-blur-sm mt-28 mb-12 rounded-xl shadow-md border border-slate-200 overflow-hidden">
          ...
          <div className="px-8 pt-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-600">How are you Today?</p>
          </div>
